@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('Gestion de Usuairo'), 'show' => 'show'])
          ...
          <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('user.index') }}" class="btn btn-sm btn-warning input-cuadrado">{{ __('Regresar a la lista') }}</a>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-success input-cuadrado">{{ __('Guardar') }}</button>
              </div>
            </div>
          </form>
        </div>
