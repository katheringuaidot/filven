@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Perfil De Usuario'), 'show' => 'show'])
        ...
        <div class="col-md-12">
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-success input-cuadrado">{{ __('Cambiar Contraseña') }}</button>
              </div>
            </div>
          </form>
        </div>
